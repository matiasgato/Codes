...
D_p=220;                %Densidad planar [g/m^3]
N=8;                    %Número de capas

%% Propiedades material 1 (Fibra de vidrio)

h_1=((D_p/1e+4)*N)/(D_f1*V_f)*10        %Espesor [mm]
...
h_2=((D_p/1e+4)*N)/(D_f2*V_f)*10        %Espesor [mm]
...
A_1=2*h_1*(Q{1,1}+Q{1,2}+Q{1,3}+Q{1,4})
...
A_2=2*h_1*(Q{2,1}+Q{2,2}+Q{2,3}+Q{2,4})

%% Propiedades efectivas

E_a1=1/(8*h_1)*(A_1(1,1)-A_1(1,2)^2/A_1(2,2))
v_a1=A_1(1,2)/A_1(1,1)
G_a1=1/(8*h_1)*A_1(3,3)

E_a2=1/(8*h_2)*(A_2(1,1)-A_2(1,2)^2/A_2(2,2))
v_a2=A_2(1,2)/A_2(1,1)
G_a2=1/(8*h_2)*A_2(3,3)
